...
```{warning}
Note that all spawnees in a queue should have `MissileSpawn` set to the same value (all true or all false). Mixing them in a queue will make missiles can't hit their targets.
```
